...
def train_data(chatbot):
    ...
    task_addons = ["what is your function","i recommend the best food to people!","what do you do","i recommend the best food to people!","That's not what i wanted","Sorry to hear that."]
